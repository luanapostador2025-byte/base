...
function Client.getMonsterByRaceId(raceId)
    return clientGetMonsterByRaceId(raceId)
end
...
--- @return the current fight mode, otherwise the last known fight mode. Refer to Enums.FightModes for possible values. Nil if the client version is 15.25 or higher.
...
--- @return false if the client version is 15.25 or higher, true otherwise for any case.
